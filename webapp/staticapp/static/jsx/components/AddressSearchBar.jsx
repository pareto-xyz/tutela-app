...
export default function AddressSearchBar({ inputAddress, setInputAddress,
    ...
    return (
        <>
            ...
            >
                ...
                <InputGroup className="fixed-width col-md-12 col-lg-8" hasValidation>
                    ...
                    <InputGroup.Text className="right-submit-icon">
                        <img width="15" src="/static/img/loupe.svg" alt="search"></img> 
                    </InputGroup.Text>
