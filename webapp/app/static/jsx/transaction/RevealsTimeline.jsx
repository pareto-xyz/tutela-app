...
export default function RevealTimeline({ addr, aliases }) {
            ...
            <div className="tornado-info col-12">
                ...
                This shows when you committed Ethereum or Tornado Cash reveals over the selected time period.
                    <ResponsiveContainer width="100%" height={400} >
                        <BarChart onClick={e => console.log(e)} data={plotData} margin={{ top: 5, right: 0, left: -30, bottom: 30 }}>
                            <CartesianGrid />
                            <XAxis dataKey="name" />
                            <YAxis />
                            <Tooltip
                            ...
                            <Bar name={aliases.torn_mine || 'torn_mine'} dataKey="torn_mine" stackId="a" fill="white" />
